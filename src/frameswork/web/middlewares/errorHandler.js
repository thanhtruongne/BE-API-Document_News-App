import { Api401Error, Api403Error, Api404Error, BaseError, BusinessLogicError } from "../plugins/error.response.js"
...
const is404Handler = (error,req, res, next) => {
    const errors = new Api404Error('Resource not found')
    next(errors)
}
...
export {
    is404Handler, isOperationalError, returnError
}
